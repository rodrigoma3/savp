...
<section class="content">
		...
		<div class="col-xs-12">
			<div class="box box-danger">
				<div class="box-body">
					<div class="row">
						<div class="col-xs-3">
							<?php echo $this->Html->link(__('Add User'), array('action' => 'add'), array('class' => 'btn btn-success btn-block')); ?>						</div>
					</div>
				</div>
			</div>
						...
						<thead>
							<tr>
																											<th><?php echo __('#'); ?></th>
																																				...
																																				<th><?php echo __('Telephone To Message'); ?></th>
																																				<th><?php echo __('Name For Message'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($user['User']['complement']); ?>&nbsp;</td>
		<td><?php echo h($user['User']['neighborhood']); ?>&nbsp;</td>
		<td><?php echo h($user['User']['telephone_to_message']); ?>&nbsp;</td>
		<td><?php echo h($user['User']['name_for_message']); ?>&nbsp;</td>
		<td>
